...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 6663 or testnet: 16663)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Dougcoin Wiki for SSL setup instructions)"),
